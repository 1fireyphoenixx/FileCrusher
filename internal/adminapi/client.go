...
func (c *Client) CreateUser(username, password, rootPath string, allowSFTP bool) (int64, error) {
	var req struct {
		Username  string `json:"username"`
		Password  string `json:"password"`
		RootPath  string `json:"root_path"`
...
func (c *Client) UpdateUser(id int64, rootPath string, enabled, allowSFTP bool) error {
	var req struct {
		RootPath  string `json:"root_path"`
		Enabled   bool   `json:"enabled"`
		AllowSFTP bool   `json:"allow_sftp"`
